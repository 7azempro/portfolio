                ...
                <div className="flex flex-col lg:grid lg:grid-cols-12 gap-24 lg:gap-12 items-start lg:items-center relative z-20 pb-40 lg:pb-0">
                    ...
                    <div className="w-full lg:col-span-7 rtl:text-right ltr:text-left relative z-30 mb-24 lg:mb-0">
                        ...
                        <div className="flex flex-col gap-6 md:gap-8 items-start border-t border-foreground/10 pt-4 md:pt-6 mt-0 relative">
                            ...
                            <div className="absolute bottom-6 left-4 right-4 z-50 lg:relative lg:bottom-auto lg:left-auto lg:right-auto lg:z-auto w-auto lg:w-full flex items-center justify-between lg:justify-start gap-4 p-3 lg:p-0 bg-foreground/5 backdrop-blur-2xl backdrop-saturate-150 border border-foreground/10 lg:border-none rounded-2xl lg:rounded-none shadow-2xl lg:shadow-none transition-all duration-300">
                                <Link
                                    href="/works"
                                    onClick={playClick}
